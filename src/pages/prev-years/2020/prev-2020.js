...
import './prev-2020.css';

const Prev2020 = () => {
  return (
    <div>
      <body>
        <div id="particles" class="wrapper-2020">
          <div class="header-2020">
            <div class="logo-2020">
              ...
              >
                <img src="images/mlh-trust-badge-2020-white.svg" />
              </a>
            </div>
          ...
          <nav
            class="navbar-2020 navbar-default navbar-expand-lg navbar-light bg-light sticky-top">
            <div class="rocket">
              <img class="animated" src="images/rocket-color.png" alt="" />
            </div>
            <button
            ...
            >
              <ul class="nav-2020 navbar-nav control-btn">
                <li class="nav-item" name="0">
                  <Link to='/2018' className="nav-link">2018</Link>
                </li>
                <li class="nav-item" name="1">
                  <a href="#schedule" class="nav-link">SCHEDULE</a>
                </li>
                <li class="nav-item" name="2">
                  <a href="https://www.facebook.com/events/507913123157623/" target="_blank" class="nav-link">FACEBOOK EVENT</a>
                </li>
                <li class="nav-item" name="4">
                  <a href="https://www.nba.com/kings/news/sacramento-kings-sachacks-and-major-league-hacking-host-second-annual-hackathon-local-college" target="_blank" class="nav-link">NEWS</a>
                </li>
                {/* <li class="nav-item" name="0">
                ...
                <li class="nav-item" name="3">
                  <a href="#sponsors" class="nav-link"> SPONSORS </a>
                </li> */}
              </ul>
            </div>
          </nav>
          <div class="homepage-2020 padding-top" id="homepage">
            <span class="logo-container"><img src="images/sachack_3.png" alt="" /></span>

            <svg class="rocket-planets" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
              viewBox="40 180 1024 768" style={ { enableBackground: "new 0 0 1024 768" } } xmlSpace="preserve">
		...
		C936.94,250.81,946.25,263.27,950.92,270.48z"/>
              ...
              <g id="Layer_5">
                <g>
                  ...
                  <ellipse transform="matrix(0.2575 -0.9663 0.9663 0.2575 255.3248 1214.3599)" class="st11" cx="917.88" cy="441.03" rx="48.02" ry="47.31" />

                  <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="789.4801" y1="453.692" x2="925.5265" y2="453.692" gradientTransform="matrix(-0.9867 0.1628 -0.171 -1.0363 1841.8173 763.731)">
                    <stop offset="0" style={ { stopColor: "#D1D3D4" } } />
                    <stop offset="0.4314" style={ { stopColor: "#88898A" } } />
                    <stop offset="0.8357" style={ { stopColor: "#414142" } } />
                  </linearGradient>
			...
			C855.24,444.51,882.58,432.93,917.18,427.22z"/>
                  ...
                  <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="816.8273" y1="438.3633" x2="951.1855" y2="438.3633" gradientTransform="matrix(-1 0 0 1 1803.0876 0)">
                    <stop offset="0.1533" style={ { stopColor: "#16445B" } } />
                    <stop offset="0.2032" style={ { stopColor: "#215168" } } />
                    <stop offset="0.3508" style={ { stopColor: "#3E7289" } } />
                    <stop offset="0.5025" style={ { stopColor: "#558CA3" } } />
                    <stop offset="0.6583" style={ { stopColor: "#659EB5" } } />
                    <stop offset="0.8206" style={ { stopColor: "#6FA9C0" } } />
                    <stop offset="1" style={ { stopColor: "#72ADC4" } } />
                  </linearGradient>
			...
			C854.85,445.8,882.2,434.21,916.79,428.51z"/>
                  ...
                  <ellipse transform="matrix(0.2575 -0.9663 0.9663 0.2575 255.8245 1214.5511)" class="st14" cx="918.25" cy="440.8" rx="43.61" ry="42.97" />
                  <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="881.4047" y1="451.2413" x2="957.4284" y2="429.5341">
                    <stop offset="0.1643" style={ { stopColor: "#414142" } } />
                    <stop offset="0.5686" style={ { stopColor: "#88898A" } } />
                    <stop offset="1" style={ { stopColor: "#D1D3D4" } } />
                  </linearGradient>
                  <circle class="st15" cx="917.96" cy="440.8" r="39.53" />

                  <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="828.0972" y1="386.1298" x2="901.079" y2="386.1298" gradientTransform="matrix(0.9663 0.2575 -0.2575 0.9663 171.9522 -176.8417)">
                    <stop offset="0.0997" style={ { stopColor: "#414142" } } />
                    <stop offset="0.267" style={ { stopColor: "#444546" } } />
                    <stop offset="0.4153" style={ { stopColor: "#4F4F50" } } />
                    <stop offset="0.5564" style={ { stopColor: "#616162" } } />
                    <stop offset="0.693" style={ { stopColor: "#7A7B7C" } } />
                    <stop offset="0.8265" style={ { stopColor: "#9B9C9D" } } />
                    <stop offset="0.9558" style={ { stopColor: "#C2C4C5" } } />
                    <stop offset="1" style={ { stopColor: "#D1D3D4" } } />
                  </linearGradient>
			...
			c2.04,0.51,11,2.93,18.51,10.89C952.6,419.91,957.72,429.8,955.26,432.3z"/>
                  ...
                  <linearGradient id="SVGID_5_" gradientUnits="userSpaceOnUse" x1="849.6772" y1="421.7995" x2="919.4396" y2="421.7995" gradientTransform="matrix(0.9663 0.2575 -0.2575 0.9663 171.9522 -176.8417)">
                    <stop offset="0" style={ { stopColor: "#414142" } } />
                    <stop offset="0.1707" style={ { stopColor: "#454546" } } />
                    <stop offset="0.3361" style={ { stopColor: "#505152" } } />
                    <stop offset="0.4994" style={ { stopColor: "#646465" } } />
                    <stop offset="0.6613" style={ { stopColor: "#7F7F80" } } />
                    <stop offset="0.8224" style={ { stopColor: "#A1A3A4" } } />
                    <stop offset="0.9806" style={ { stopColor: "#CBCDCE" } } />
                    <stop offset="1" style={ { stopColor: "#D1D3D4" } } />
                  </linearGradient>
			...
			c1.97-0.73,10.61-4.13,17.2-12.86C956.49,456.26,957.02,445.81,956.33,445.57z"/>
                  ...
                  <linearGradient id="SVGID_6_" gradientUnits="userSpaceOnUse" x1="897.5562" y1="595.1949" x2="915.5227" y2="593.9443" gradientTransform="matrix(0.9663 -0.2575 -0.2575 -0.9663 171.9522 1250.3927)">
                    <stop offset="0" style={ { stopColor: "#414142" } } />
                    <stop offset="0.9373" style={ { stopColor: "#414142", stopOpacity: 0 } } />
                  </linearGradient>
			...
			C887.65,452.87,887.06,450.66,888.42,447.32z"/>
                  ...
                  <linearGradient id="SVGID_7_" gradientUnits="userSpaceOnUse" x1="653.3228" y1="613.7537" x2="668.2711" y2="613.7537" gradientTransform="matrix(-0.879 1.5704 0.7001 0.3919 1044.7446 -858.7759)">
                    <stop offset="0.0997" style={ { stopColor: '#414142' } } />
                    <stop offset="0.2037" style={ { stopColor: "#414142", stopOpacity: 0.8845 } } />
                    <stop offset="1" style={ { stopColor: "#414142", stopOpacity: 0 } } />
                  </linearGradient>
			...
			C883.52,430.16,885.59,429.4,885.68,429.37z"/>
                  ...
                  <linearGradient id="SVGID_8_" gradientUnits="userSpaceOnUse" x1="646.4888" y1="455.3477" x2="659.9884" y2="455.3477" gradientTransform="matrix(-1.1801 0.8834 -0.3857 -0.5153 1896.7556 97.6907)">
                    <stop offset="0" style={ { stopColor: '#414142' } } />
                    <stop offset="0.9373" style={ { stopColor: '#414142', stopOpacity: 0 } } />
                  </linearGradient>
			...
			c-2.53,2.71-4.26,4.57-6.55,4.4C942.59,455.78,940.7,454,940.86,453.01z"/>
                  ...
                  <linearGradient id="SVGID_9_" gradientUnits="userSpaceOnUse" x1="774.4512" y1="614.9326" x2="789.3994" y2="614.9326" gradientTransform="matrix(0.2483 0.6273 -0.6557 0.2596 1129.4172 -242.8354)">
                    <stop offset="0.0997" style={ { stopColor: '#414142' } } />
                    <stop offset="0.2037" style={ { stopColor: '#414142', stopOpacity: 0.8845 } } />
                    <stop offset="1" style={ { stopColor: '#414142', stopOpacity: 0 } } />
                  </linearGradient>
			...
			C925.3,411.06,923.89,410.94,923.83,410.94z"/>
                  ...
                  <linearGradient id="SVGID_10_" gradientUnits="userSpaceOnUse" x1="987.9031" y1="268.7116" x2="1005.7896" y2="268.7116" gradientTransform="matrix(1.4685 0.1284 -0.0561 0.6413 -520.5634 132.9741)">
                    <stop offset="0" style={ { stopColor: "#414142" } } />
                    <stop offset="0.9373" style={ { stopColor: "#414142", stopOpacity: 0 } } />
                  </linearGradient>
			...
			c0.89,0.07,3.99,0.33,7.34,2.14C938.94,430.97,941.26,432.22,941.38,434.18z"/>
                  ...
                  <linearGradient id="SVGID_11_" gradientUnits="userSpaceOnUse" x1="946.1555" y1="506.7278" x2="972.3824" y2="487.762" gradientTransform="matrix(0.9867 -0.1627 0.1627 0.9867 -110.2195 124.0542)">
                    <stop offset="0.4828" style={ { stopColor: '#414142', stopOpacity: 0.3481 } } />
                    <stop offset="0.9373" style={ { stopColor: '#414142', stopOpacity: 0 } } />
                  </linearGradient>
			...
			C940.27,464.82,942.7,467.55,941.02,469.42z"/>
                  ...
                  <linearGradient id="SVGID_12_" gradientUnits="userSpaceOnUse" x1="789.4536" y1="431.3589" x2="925.4999" y2="431.3589" gradientTransform="matrix(-0.9867 0.1628 0.1628 0.9867 1696.5729 -116.4337)">
                    <stop offset="0" style={ { stopColor: "#D1D3D4" } } />
                    <stop offset="0.4314" style={ { stopColor: "#88898A" } } />
                    <stop offset="0.8357" style={ { stopColor: "#414142" } } />
                  </linearGradient>
			...
			C857.54,458.31,887.1,460.16,921.7,454.46z"/>
                  ...
                  <linearGradient id="SVGID_13_" gradientUnits="userSpaceOnUse" x1="816.7621" y1="446.2267" x2="951.1085" y2="446.2267" gradientTransform="matrix(-1 0 0 1 1803.0876 0)">
                    <stop offset="0.1533" style={ { stopColor: "#16445B" } } />
                    <stop offset="0.2032" style={ { stopColor: "#215168" } } />
                    <stop offset="0.3508" style={ { stopColor: "#3E7289" } } />
                    <stop offset="0.5025" style={ { stopColor: "#558CA3" } } />
			...
			C857.16,459.6,886.72,461.45,921.32,455.74z"/>
              ...
              <g id="background">
                <g>
                  ...
                  <linearGradient id="SVGID_14_" gradientUnits="userSpaceOnUse" x1="712.5434" y1="475.0744" x2="762.8135" y2="475.0744" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0" style={ { stopColor: "#002561" } } />
                    <stop offset="0.1858" style={ { stopColor: "#194377" } } />
                    <stop offset="0.5662" style={ { stopColor: "#497CA0" } } />
                    <stop offset="0.8488" style={ { stopColor: "#67A0BA" } } />
                    <stop offset="1" style={ { stopColor: "#72ADC4" } } />
                  </linearGradient>
			...
			c0.01,0.09,0.02,0.18,0.03,0.27l24.18,128.61l30.46-5.73L733.4,421.75C733.38,421.66,733.35,421.58,733.33,421.49z"/>
                  ...
                  <rect x="726.62" y="550.62" transform="matrix(0.9828 -0.1847 0.1847 0.9828 -89.1922 146.6001)" class="st27" width="30.97" height="2.63" />

                  <rect x="724.13" y="537.39" transform="matrix(0.9828 -0.1847 0.1847 0.9828 -86.7922 145.9133)" class="st28" width="30.97" height="2.63" />

                  <linearGradient id="SVGID_15_" gradientUnits="userSpaceOnUse" x1="729.3833" y1="562.1271" x2="768.2476" y2="562.1271" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0.1533" style={ { stopColor: "#16445B" } } />
                    <stop offset="0.2032" style={ { stopColor: "#215168" } } />
                    <stop offset="0.3508" style={ { stopColor: "#3E7289" } } />
                    <stop offset="0.5025" style={ { stopColor: "#558CA3" } } />
			...
			c2.4-0.45,4.09-2.19,3.77-3.89l-0.85-4.51C762.2,554.42,759.99,553.41,757.59,553.86z"/>
                  ...
                  <linearGradient id="SVGID_16_" gradientUnits="userSpaceOnUse" x1="726.9633" y1="558.9158" x2="771.0413" y2="558.9158" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0" style={ { stopColor: "#002561" } } />
                    <stop offset="0.1858" style={ { stopColor: "#194377" } } />
                    <stop offset="0.5662" style={ { stopColor: "#497CA0" } } />
                    <stop offset="0.8488" style={ { stopColor: "#67A0BA" } } />
			...
			756.1,561 759.46,560.37 759.46,560.35 766.13,559.07 		"/>
                  ...
                  <linearGradient id="SVGID_17_" gradientUnits="userSpaceOnUse" x1="736.9894" y1="568.9729" x2="762.6842" y2="568.9729" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0.1533" style={ { stopColor: "#16445B" } } />
                    <stop offset="0.2032" style={ { stopColor: "#215168" } } />
                    <stop offset="0.3508" style={ { stopColor: "#3E7289" } } />
                    <stop offset="0.5025" style={ { stopColor: "#558CA3" } } />
			...
			l23.45-4.41c0.53-0.1,1.04,0.25,1.14,0.78l0.19,1.03C758.14,567.4,757.79,567.91,757.27,568.01z"/>
                  ...
                  <linearGradient id="SVGID_18_" gradientUnits="userSpaceOnUse" x1="614.9335" y1="489.7291" x2="665.2036" y2="489.7291" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0" style={ { stopColor: "#002561" } } />
                    <stop offset="0.1858" style={ { stopColor: "#194377" } } />
                    <stop offset="0.5662" style={ { stopColor: "#497CA0" } } />
                    <stop offset="0.8488" style={ { stopColor: "#67A0BA" } } />
			...
			c0.01,0.09,0.02,0.18,0.03,0.27l24.18,128.61l30.46-5.73l-24.18-128.61C636.38,439.88,636.35,439.8,636.33,439.71z"/>
                  ...
                  <rect x="629.61" y="568.84" transform="matrix(0.9828 -0.1847 0.1847 0.9828 -94.2284 128.9922)" class="st27" width="30.97" height="2.63" />

                  <rect x="627.13" y="555.62" transform="matrix(0.9828 -0.1847 0.1847 0.9828 -91.8284 128.3054)" class="st28" width="30.97" height="2.63" />

                  <linearGradient id="SVGID_19_" gradientUnits="userSpaceOnUse" x1="619.2735" y1="628.0636" x2="657.8485" y2="628.0636" gradientTransform="matrix(0.9828 -0.1847 0.1847 0.9828 -96.6281 80.8736)">
                    <stop offset="0.1533" style={ { stopColor: "#16445B" } } />
                    <stop offset="0.2032" style={ { stopColor: "#215168" } } />
                    <stop offset="0.3508" style={ { stopColor: "#3E7289" } } />
                    <stop offset="0.5025" style={ { stopColor: "#558CA3" } } />
			...
			c2.4-0.45,4.09-2.19,3.77-3.89l-0.85-4.51C665.19,572.64,662.99,571.63,660.58,572.08z"/>
                  ...
                  <linearGradient id="SVGID_20_" gradientUnits="userSpaceOnUse" x1="629.3535" y1="573.5706" x2="673.4314" y2="573.5706" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0" style={ { stopColor: "#002561" } } />
                    <stop offset="0.1858" style={ { stopColor: "#194377" } } />
                    <stop offset="0.5662" style={ { stopColor: "#497CA0" } } />
                    <stop offset="0.8488" style={ { stopColor: "#67A0BA" } } />
			...
			662.45,578.59 662.45,578.58 669.12,577.29 		"/>
                  ...
                  <linearGradient id="SVGID_21_" gradientUnits="userSpaceOnUse" x1="639.3795" y1="583.6276" x2="665.0743" y2="583.6276" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0.1533" style={ { stopColor: "#16445B" } } />
                    <stop offset="0.2032" style={ { stopColor: "#215168" } } />
                    <stop offset="0.3508" style={ { stopColor: "#3E7289" } } />
                    <stop offset="0.5025" style={ { stopColor: "#558CA3" } } />
			...
			l23.45-4.41c0.53-0.1,1.04,0.25,1.14,0.78l0.19,1.03C661.13,585.62,660.78,586.13,660.26,586.23z"/>
                  ...
                  <linearGradient id="SVGID_22_" gradientUnits="userSpaceOnUse" x1="634.4445" y1="420.0943" x2="728.6584" y2="420.0943" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0.1533" style={ { stopColor: "#16445B" } } />
                    <stop offset="0.2032" style={ { stopColor: "#215168" } } />
                    <stop offset="0.3508" style={ { stopColor: "#3E7289" } } />
                    <stop offset="0.5025" style={ { stopColor: "#558CA3" } } />
			...
			C692.53,363.66,691.91,361.84,691.07,360.14z"/>
                  ...
                  <rect x="662.74" y="525.67" transform="matrix(0.9828 -0.1847 0.1847 0.9828 -85.5841 136.076)" class="st28" width="49.38" height="3.27" />

                  <rect x="683.76" y="539.6" transform="matrix(-0.1847 -0.9828 0.9828 -0.1847 285.5648 1319.3514)" class="st28" width="12.5" height="3.27" />

                  <linearGradient id="SVGID_23_" gradientUnits="userSpaceOnUse" x1="587.9584" y1="494.6817" x2="817.3719" y2="494.6817" gradientTransform="matrix(1 -6.887563e-03 6.887563e-03 1 -12.7881 10.3511)">
                    <stop offset="0" style={ { stopColor: "#002561" } } />
                    <stop offset="0.1858" style={ { stopColor: "#194377" } } />
                    <stop offset="0.5662" style={ { stopColor: "#497CA0" } } />
                    <stop offset="0.8488" style={ { stopColor: "#67A0BA" } } />
			...
			c0.89,2.02,1.79,4.03,2.72,6.03c-0.45,0.08-0.89,0.17-1.34,0.25C693.55,527.95,693.09,525.86,692.62,523.77z"/>
                  ...
                  <linearGradient id="SVGID_24_" gradientUnits="userSpaceOnUse" x1="668.9623" y1="559.6646" x2="690.9109" y2="559.6646" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0.1533" style={ { stopColor: "#16445B" } } />
                    <stop offset="0.2032" style={ { stopColor: "#215168" } } />
                    <stop offset="0.3508" style={ { stopColor: "#3E7289" } } />
                    <stop offset="0.5025" style={ { stopColor: "#558CA3" } } />
			...
			l19.23-3.61c0.65-0.12,1.28,0.31,1.4,0.96l0.24,1.28C686.11,561.26,685.68,561.89,685.03,562.01z"/>
                  ...
                  <linearGradient id="SVGID_25_" gradientUnits="userSpaceOnUse" x1="705.5803" y1="554.1618" x2="727.5289" y2="554.1618" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0.1533" style={ { stopColor: "#16445B" } } />
                    <stop offset="0.2032" style={ { stopColor: "#215168" } } />
                    <stop offset="0.3508" style={ { stopColor: "#3E7289" } } />
                    <stop offset="0.5025" style={ { stopColor: "#558CA3" } } />
			...
			l19.23-3.61c0.65-0.12,1.28,0.31,1.4,0.96l0.24,1.28C722.5,554.42,722.07,555.05,721.42,555.17z"/>
                  ...
                  <rect x="622.3" y="527.56" transform="matrix(0.9828 -0.1847 0.1847 0.9828 -86.7936 126.8648)" class="st40" width="30.21" height="3.27" />

                  <rect x="614.54" y="533.61" transform="matrix(0.9828 -0.1847 0.1847 0.9828 -87.9687 126.3499)" class="st40" width="39.03" height="3.27" />

                  <rect x="719.59" y="508.22" transform="matrix(-0.9828 0.1847 -0.1847 -0.9828 1550.9377 875.2077)" class="st40" width="30.21" height="3.27" />

                  <rect x="720.5" y="512.64" transform="matrix(-0.9828 0.1847 -0.1847 -0.9828 1562.2988 882.9884)" class="st40" width="39.03" height="3.27" />
			...
			L707.58,464.14z"/>
                  ...
                  <rect x="587.13" y="549.76" transform="matrix(0.9828 -0.1847 0.1847 0.9828 -89.9465 137.2626)" class="st40" width="208.98" height="3.11" />

                  <linearGradient id="SVGID_26_" gradientUnits="userSpaceOnUse" x1="661.5298" y1="551.1967" x2="695.8218" y2="551.1967" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0" style={ { stopColor: '#002561' } } />
                    <stop offset="0.1858" style={ { stopColor: '#194377' } } />
                    <stop offset="0.5662" style={ { stopColor: '#497CA0' } } />
                    <stop offset="0.8488" style={ { stopColor: '#67A0BA' } } />
			...
			c2.1-0.4,3.48-2.42,3.09-4.52l-1.05-5.58C689.16,545.58,687.14,544.19,685.03,544.59z"/>
                  ...
                  <linearGradient id="SVGID_27_" gradientUnits="userSpaceOnUse" x1="698.1245" y1="545.6946" x2="732.4397" y2="545.6946" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0" style={ { stopColor: '#002561' } } />
                    <stop offset="0.1858" style={ { stopColor: '#194377' } } />
                    <stop offset="0.5662" style={ { stopColor: '#497CA0' } } />
                    <stop offset="0.8488" style={ { stopColor: '#67A0BA' } } />
			...
			c-0.02-0.13-0.07-0.24-0.11-0.36C725.75,540.46,725.67,540.42,725.61,540.35z"/>
                  ...
                  <linearGradient id="SVGID_28_" gradientUnits="userSpaceOnUse" x1="661.5251" y1="537.0601" x2="731.6178" y2="537.0601" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0" style={ { stopColor: "#002561" } } />
                    <stop offset="0.1858" style={ { stopColor: "#194377" } } />
                    <stop offset="0.5662" style={ { stopColor: "#497CA0" } } />
                    <stop offset="0.8488" style={ { stopColor: "#67A0BA" } } />
			...
			c0.04,0.02,0.09,0.04,0.13,0.06c0.01,0,0.02,0.01,0.03,0.01C690.66,394.21,680.92,358.1,676.28,349.14z"/>
                  ...
                  <linearGradient id="SVGID_29_" gradientUnits="userSpaceOnUse" x1="651.4814" y1="451.2841" x2="718.607" y2="451.2841" gradientTransform="matrix(0.9993 -0.0366 0.0366 0.9993 -24.9214 27.6261)">
                    <stop offset="0" style={ { stopColor: '#002561' } } />
                    <stop offset="0.1858" style={ { stopColor: '#194377' } } />
                    <stop offset="0.5662" style={ { stopColor: '#497CA0' } } />
                    <stop offset="0.8488" style={ { stopColor: '#67A0BA' } } />
			...
			C585.13,567.7,586.09,558.8,587.04,549.9z"/>
				...
				l4.97-0.93c0.39-0.07,0.77,0.19,0.85,0.58l0.14,0.77C680.94,575.63,680.68,576.01,680.29,576.09z"/>
                  ...
                  <rect x="662.12" y="522.25" transform="matrix(0.9828 -0.1847 0.1847 0.9828 -84.9818 135.9034)" class="st40" width="49.38" height="3.49" />
			...
			l1.93-0.36l-0.58-3.07l-0.13-0.7C687.77,442.8,681.28,408.42,681.04,407.53z"/>
                ...
                <g>
                  <g>
                    <linearGradient id="SVGID_30_" gradientUnits="userSpaceOnUse" x1="696.5548" y1="296.0945" x2="946.314" y2="296.0945">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.2032" style={ { stopColor: '#215168' } } />
                      <stop offset="0.3508" style={ { stopColor: '#3E7289' } } />
                      <stop offset="0.5025" style={ { stopColor: '#558CA3' } } />
				...
				C940.83,309.91,890,288.38,825.69,277.77z"/>
                    ...
                    <linearGradient id="SVGID_31_" gradientUnits="userSpaceOnUse" x1="646.2015" y1="581.9431" x2="899.0989" y2="581.9431" gradientTransform="matrix(0.9867 0.1628 0.171 -1.0363 -38.7296 763.731)">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.2032" style={ { stopColor: '#215168' } } />
                      <stop offset="0.3508" style={ { stopColor: '#3E7289' } } />
                      <stop offset="0.5025" style={ { stopColor: '#558CA3' } } />
				...
				C940.11,307.52,889.28,285.99,824.97,275.38z"/>
                    <linearGradient id="SVGID_32_" gradientUnits="userSpaceOnUse" x1="737.636" y1="301.7141" x2="904.8275" y2="301.7141">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.2032" style={ { stopColor: '#215168' } } />
                      <stop offset="0.3508" style={ { stopColor: '#3E7289' } } />
                      <stop offset="0.5025" style={ { stopColor: '#558CA3' } } />
				...
				s57.94-72.26,102.5-60.38C887.61,231.71,913.96,277.99,901.91,323.22z"/>
                    <linearGradient id="SVGID_33_" gradientUnits="userSpaceOnUse" x1="744.4083" y1="301.7141" x2="898.0552" y2="301.7141">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.2032" style={ { stopColor: '#215168' } } />
                      <stop offset="0.3508" style={ { stopColor: '#3E7289' } } />
                      <stop offset="0.5025" style={ { stopColor: '#558CA3' } } />
                    ...
                    <linearGradient id="SVGID_34_" gradientUnits="userSpaceOnUse" x1="675.0826" y1="259.1517" x2="816.8998" y2="259.1517" gradientTransform="matrix(0.9663 0.2575 -0.2575 0.9663 171.9522 -176.8417)">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.2032" style={ { stopColor: '#215168' } } />
                      <stop offset="0.3508" style={ { stopColor: '#3E7289' } } />
                      <stop offset="0.5025" style={ { stopColor: '#558CA3' } } />
				...
				c3.97,0.99,21.37,5.7,35.97,21.16C888.54,261.12,898.5,280.32,893.71,285.19z"/>
                    ...
                    <linearGradient id="SVGID_35_" gradientUnits="userSpaceOnUse" x1="691.871" y1="328.4645" x2="827.4323" y2="328.4645" gradientTransform="matrix(0.9663 0.2575 -0.2575 0.9663 171.9522 -176.8417)">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.2032" style={ { stopColor: '#215168' } } />
                      <stop offset="0.3508" style={ { stopColor: '#3E7289' } } />
                      <stop offset="0.5025" style={ { stopColor: '#558CA3' } } />
				...
				c19.72,20,53.48,27.18,81.52,16.77c3.83-1.42,20.61-8.02,33.43-24.99C896.1,331.75,897.14,311.44,895.79,310.97z"/>
                    ...
                    <linearGradient id="SVGID_36_" gradientUnits="userSpaceOnUse" x1="786.1467" y1="284.934" x2="786.1467" y2="264.0167" gradientTransform="matrix(0.9663 0.2575 -0.2575 0.9663 171.9522 -176.8417)">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.2032" style={ { stopColor: '#215168' } } />
                      <stop offset="0.3508" style={ { stopColor: '#3E7289' } } />
                      <stop offset="0.5025" style={ { stopColor: '#558CA3' } } />
                    ...
                    <linearGradient id="SVGID_37_" gradientUnits="userSpaceOnUse" x1="716.8147" y1="313.4383" x2="716.8147" y2="295.1906" gradientTransform="matrix(0.9663 0.2575 -0.2575 0.9663 171.9522 -176.8417)">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.2032" style={ { stopColor: '#215168' } } />
                      <stop offset="0.3508" style={ { stopColor: '#3E7289' } } />
                      <stop offset="0.5025" style={ { stopColor: '#558CA3' } } />
                    ...
                    <linearGradient id="SVGID_38_" gradientUnits="userSpaceOnUse" x1="777.1514" y1="345.6784" x2="777.1514" y2="332.6302" gradientTransform="matrix(0.9663 0.2575 -0.2575 0.9663 171.9522 -176.8417)">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.2032" style={ { stopColor: '#215168' } } />
                      <stop offset="0.3508" style={ { stopColor: '#3E7289' } } />
                      <stop offset="0.5025" style={ { stopColor: '#558CA3' } } />
                    ...
                    <linearGradient id="SVGID_39_" gradientUnits="userSpaceOnUse" x1="700.2928" y1="326.4866" x2="700.2928" y2="313.4383" gradientTransform="matrix(0.9663 0.2575 -0.2575 0.9663 171.9522 -176.8417)">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.2032" style={ { stopColor: '#215168' } } />
                      <stop offset="0.3508" style={ { stopColor: '#3E7289' } } />
                      <stop offset="0.5025" style={ { stopColor: '#558CA3' } } />
                    ...
                    <linearGradient id="SVGID_40_" gradientUnits="userSpaceOnUse" x1="601.5459" y1="386.6812" x2="630.5931" y2="386.6812" gradientTransform="matrix(-0.879 1.5704 0.7001 0.3919 1044.7446 -858.7759)">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.3983" style={ { stopColor: '#2D5F76', stopOpacity: 0.8553 } } />
                      <stop offset="0.9213" style={ { stopColor: '#69A2B9', stopOpacity: 0.5465 } } />
                      <stop offset="1" style={ { stopColor: '#72ADC4', stopOpacity: 0.5 } } />
                    </linearGradient>
				...
				c-2.93,5.1-6.56,13.3-5.53,17.3C754.3,281.03,758.34,279.56,758.51,279.49z"/>
                    ...
                    <linearGradient id="SVGID_41_" gradientUnits="userSpaceOnUse" x1="642.543" y1="661.3287" x2="671.5903" y2="661.3287" gradientTransform="matrix(-1.1801 0.8834 -0.3857 -0.5153 1896.7556 97.6907)">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.3983" style={ { stopColor: '#2D5F76', stopOpacity: 0.8553 } } />
                      <stop offset="0.9213" style={ { stopColor: '#69A2B9', stopOpacity: 0.5465 } } />
                      <stop offset="1" style={ { stopColor: '#72ADC4', stopOpacity: 0.5 } } />
				...
				c-3.83,2.93-10.08,6.78-13.42,6.41C851.41,355.44,852.2,352.04,852.24,351.89z"/>
                    ...
                    <linearGradient id="SVGID_42_" gradientUnits="userSpaceOnUse" x1="480.5602" y1="650.3345" x2="509.6074" y2="650.3345" gradientTransform="matrix(0.2483 0.6273 -0.6557 0.2596 1129.4172 -242.8354)">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.3983" style={ { stopColor: '#2D5F76', stopOpacity: 0.8553 } } />
                      <stop offset="0.9213" style={ { stopColor: '#69A2B9', stopOpacity: 0.5465 } } />
                      <stop offset="1" style={ { stopColor: '#72ADC4', stopOpacity: 0.5 } } />
				...
				c0.87,2.03,1.42,5.41-0.51,7.38C835.5,243.92,832.76,243.69,832.65,243.68z"/>
                    ...
                    <linearGradient id="SVGID_43_" gradientUnits="userSpaceOnUse" x1="992.4961" y1="1050.9929" x2="1021.5433" y2="1050.9929" gradientTransform="matrix(-0.2996 -0.7568 0.565 -0.2237 490.13 1333.6798)">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.3983" style={ { stopColor: '#2D5F76', stopOpacity: 0.8553 } } />
                      <stop offset="0.9213" style={ { stopColor: '#69A2B9', stopOpacity: 0.5465 } } />
                      <stop offset="1" style={ { stopColor: '#72ADC4', stopOpacity: 0.5 } } />
				...
				C772.64,326.77,775.15,327.36,775.26,327.38z"/>
                    ...
                    <linearGradient id="SVGID_44_" gradientUnits="userSpaceOnUse" x1="646.1522" y1="310.2414" x2="899.0496" y2="310.2414" gradientTransform="matrix(0.9867 0.1628 -0.1628 0.9867 106.5148 -116.4337)">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.2032" style={ { stopColor: '#215168' } } />
                      <stop offset="0.3508" style={ { stopColor: '#3E7289' } } />
                      <stop offset="0.5025" style={ { stopColor: '#558CA3' } } />
				...
				C935.83,333.18,880.88,336.62,816.57,326.01z"/>
                    <linearGradient id="SVGID_45_" gradientUnits="userSpaceOnUse" x1="696.4335" y1="310.7118" x2="946.1709" y2="310.7118">
                      <stop offset="0.1533" style={ { stopColor: '#16445B' } } />
                      <stop offset="0.2032" style={ { stopColor: '#215168' } } />
                      <stop offset="0.3508" style={ { stopColor: '#3E7289' } } />
                      <stop offset="0.5025" style={ { stopColor: '#558CA3' } } />
				...
				C936.54,335.57,881.59,339.02,817.28,328.4z"/>
                  ...
                  <ellipse transform="matrix(0.2575 -0.9663 0.9663 0.2575 319.3405 1017.6268)" class="st11" cx="821.87" cy="301.01" rx="95.61" ry="94.2" />
                </g>
              </g>
              <g id="Layer_8">
              </g>
            </svg>
            <div class="detail-2020">
              <h3 id="space"><a href="https://goo.gl/maps/p6W1icg6zideF4Kz8"
                target="_blank" style={ { color: 'white', textDecoration: 'none' } }>Allegiant Innovation Center @ Sacramento, CA</a></h3>
              <h5 class="yellow">February 22-23, 2020</h5>
              <div class="host">
                ...
                <a
                  ...
                  target="_blank"
                ><img src="images/sac_kings_logo.png" height="95px" width="80px"
                  /></a>
              </div>
          ...
          <div class="about-2020 padding-top" id="about">
            <div class="about-content">
              ...
              <img class="about-image" src="images/aboutimage.png" />
            </div>
          </div>
          {/* <!-- Schedule page --> */ }
          <div class="schedule-2020 padding-top" id="schedule">
            <div class="schedule-header">
              <h1>Saturday 2/22/20</h1>
            ...
            <table class="tb-active tb-1">
              <tr>
                ...
                <td class="t-desc"> Sign in! Check in at the main entrance of the            <a href="https://goo.gl/maps/p6W1icg6zideF4Kz8" target="_blank" style={ { color: 'white', textDecoration: 'none' } }>Allegiant Innovaion Center. Click here for the map.</a></td>
              </tr>
              <tr>
                <td class="t-time"> 9 AM </td>
                <td class="t-event"> Opening Ceremony </td>
                <td class="t-desc"> Hear from tech entrepreneur and investor Sonny Mayugba! </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="t-desc"> Amazing food from Red Robin! </td>
              </tr>
              <tr>
                <td class="t-time"> 1 PM </td>
                <td class="t-event">Datathon for Social Good: ML on Z</td>
                <td class="t-desc"> Learn about machine learning on Z from IBM engineers! </td>
              </tr>
              <tr>
                <td class="t-time"> 2:15 PM </td>
                <td class="t-event"> Design Thinking Workshop </td>
                <td class="t-desc"> Learn the Design Basics as well as basic wireframing and prototyping techniques from UC Davis Lecturer Bill Mead.</td>
              </tr>
              <tr>
                <td class="t-time"> 3:30 PM </td>
                <td class="t-event">Data Analytics in Health Workshop </td>
                <td class="t-desc"> Learn about from UC Davis Center for Data Science and Artificial Intelligence Research faculty!</td>
              </tr>
              <tr>
                <td class="t-time"> 4:45 PM </td>
                <td class="t-event">Intro to Full-Stack Web Dev Workshop </td>
                <td class="t-desc"> Learn to code with HTML, CSS, JavaScript, Node.js, Express, Promises, and much more from Lorman Lau, Software Engineer at SAP SuccessFactors!</td>
              </tr>
              <tr>
                <td class="t-time"> 6 PM </td>
                <td class="t-event"> Google Cloud Platform Workshop </td>
                <td class="t-desc"> Learn how to use the GCP from Davis Developer Student Club!</td>
              </tr>
              <tr>
                <td class="t-time"> 6:30 PM </td>
                <td class="t-event"> Dinner </td>
                <td class="t-desc">Did anyone say they want more Red Robin?</td>
              </tr>
              <tr>
                <td class="t-time"> 7:15 PM </td>
                <td class="t-event">UC Davis Student Startup Center Intro to Virtual Reality Workshop </td>
                <td class="t-desc"> Learn the basics of on virtual reality from the VR managers of the UC Davis Student Startup Center. </td>
              </tr>
              <tr>
                <td class="t-time"> 8:30 PM </td>
                <td class="t-event">MLH Slideshow Karaoke</td>
                <td class="t-desc">Think on your toes with this fun improv game. Be the expert of a set of slides, without knowing the topic beforehand!</td>
              </tr>
              <tr>
                <td class="t-time"> 9:00 PM </td>
                <td class="t-event"> MLH Capture the Flag Cyber Security Event </td>
                <td class="t-desc"> CTF is a series of cybersecurity challenges, sponsored by the U.S. Airforce! Whether you're a pro hacker or never written a code in your life, it'll be fun! </td>
              </tr>
            </table>

            <div class="schedule-header">
              <h1>Sunday 2/23/20</h1>
              {/* <!-- <div class="schedule-buttons">
              <button class="btn-sched btn-active btn-1">Sat, Nov 17th </button>
              <!--<button class="btn-sched btn-inactive btn-2">Sun, Nov 18th</button>-->
            <!--</div>--> */}
            ...
            <table class="tb-active tb-1">
              <tr>
                ...
                <td class="t-desc"> Cookies and tea! Also snacks are stocked! </td>
              </tr>
              <tr>
                <td class="t-time"> 8 AM </td>
                <td class="t-event"> Breakfast </td>
                <td class="t-desc">We hope you have a sweet tooth.</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="t-desc"> Congratulation on finishing! </td>
              </tr>
              <tr>
                <td class="t-time"> 11 AM </td>
                <td class="t-event"> Lunch </td>
                <td class="t-desc">Eat some subs right before your dub.</td>
              </tr>
              <tr>
                <td class="t-time"> 12 PM </td>
                <td class="t-event"> Demos and Judging </td>
                <td class="t-desc"> Show off the cool projects you've made. </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="t-desc">Congrats! You did it!</td>
              </tr>
            </table>
          </div>
          <div class="FAQ-2020 padding-top" id="faq">
            <h1>Frequently Asked Questions</h1>
            <div class="Q-and-A">
              <li>
                <h3>What is a hackathon?</h3>
                <p>
                  A hackathon occurs when passionate people gather together to
                  create, build, and launch their ideas with tech.
            </p>
              </li>
              <li>
                <h3>How much does it cost?</h3>
                <p>
                  Everything is provided by our team and sponsors. The event is free
                  to attend.
            </p>
              </li>
              <li>
          ...
          <li>
              ...
              <p>
                Yes! We'd love for you to apply to be a volunteer. A link to the
                volunteer application will be out soon.
            </p>
            </li> --> */}
              <li>
                <h3>Will SacHacks provide travel reimbursements? </h3>
                <p>
          ...
          <div class="sponsor-2020 padding-top" id="sponsors">
            <h1>Sponsors</h1>
            {/* <!-- <h4>
            ...
            <div class="list-sponsor">
              <div class="list-sponsor-row">
                <a href="https://www.nba.com/kings/" target="_blank">
                  <img class="kings" src="images/sac_kings_logo.png" />
                </a>
              </div>
            </div>
            <div class="list-sponsor-row">
              <a href="https://innovationcenter.allegiantgiving.org/" target="_blank">
                <img class="allegiant" src="images/allegiant.png" />
              </a>
              <a href="https://citris-uc.org/" target="_blank">
                <img class="citris" src="images/citris.png" />
              </a>
            </div>
            <div class="list-sponsor-row">
              <a href="https://www.ibm.com/" target="_blank">
                <img class="ibm" src="images/IBM_LOGO-01.png" />
              </a>
              <a href="http://engineering.ucdavis.edu/" target="_blank">
                <img class="coe" src="images/College-of-engineering.png" />
              </a>
            </div>
            <div class="list-sponsor-row">
              <a href="https://cedar.ucdavis.edu/" target="_blank">
                <img class="cedar" src="images/Data%20ScienceLogo_White.png" />
              </a>
              <a href="https://startup.ucdavis.edu/" target="_blank">
                <img class="ssc" src="images/ucd_ssc.png" />
              </a>
            </div>
            <div class="list-sponsor-row">
              <a href="http://hackp.ac/mlh-stickermule-hackathons" target="_blank">
                <img class="stickermule" src="images/sticker-mule-logo.png" />
              </a>
              <a href="https://www.sketch.com/" target="_blank">
                <img class="sketch" src="images/sketch.png" />
              </a>
              <a href="http://github.com" target="_blank">
                <img class="git" src="images/github-logo.png" />
              </a>
            </div>
            <div class="list-sponsor-row">
              <a href="https://eatbobos.com/" target="_blank">
                <img class="bobos" src="images/bobos.png" />
              </a>
              <a href="https://guayaki.com/yerba-mate/" target="_blank">
                <img class="yerba" src="images/yerbaNew.png" />
              </a>
              <a href="https://zesttea.com/" target="_blank">
                <img class="zesttea" src="images/zesttea.png" />
              </a>
            </div>
            <br></br>
            <h1>Partners</h1>
            ...
            <div class="list-sponsor">
              ...
              <div class="list-sponsor-row">
                <a href="https://hackerlab.org/en" target="_blank">
                  <img class="hackerlab"
                    src="images/HL-Logo-Traditional.png"
                  />
                </a>
                <a href="https://www.meetup.com/freeCodeCamp-Greater-Sacramento-Area/" target="_blank">
                  <img class="freecodecamp"
                    src="images/fcc_eg_logo_transparent.png"
                  />
                </a>
              </div>
              <div class="list-sponsor-row">
                <a href="http://losriosccd.acm.org/" target="_blank">
                  <img class="acm"
                    src="images/acm.png"
                  />
                </a>
                ...
                <a href="https://www.facebook.com/DavisWICS/" target="_blank">
                  <img class="wics"
                    src="images/wics.png"
                  />
                </a>
          ...
          <div class="footer-bar">
            ...
            <ul class="icon-bar">
              <li>
                <a href="https://www.facebook.com/sachacks/"
                ><i
                  style={ { color: 'white' } }
              ...
              <li>
                <a href="https://www.linkedin.com/company/sachacks/"
                ><i
                  style={ { color: 'white' } }
              ...
              <li>
                <a href="https://www.instagram.com/sachacks/?hl=en"
                ><i
                  style={ { color: 'white' } }
              ...
              <li>
                <a href="https://twitter.com/SacHacks2020"
                ><i
                  style={ { color: 'white' } }
